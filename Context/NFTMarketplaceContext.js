...
const projectId = "2Oc0yooMH1iXdrkkOG5UolupEuj";
const projectSecretKey = "93ec0ae0be7475fba1f05fb0d55be7fe";
const auth = `Basic ${Buffer.from(`${projectId}:${projectSecretKey}`).toString(
  "base64"
)}`;

const subdomain = "https://pratham-nft-marketplace.infura-ipfs.io";
...
export const NFTMarketplaceProvider = ({ children }) => {
  ...
  const fetchNFTs = async () => {
    try {
     // if (currentAccount) {
        const provider = new ethers.providers.JsonRpcProvider("https://polygon-mumbai.g.alchemy.com/v2/1Rc8u7SyG7udLUDcT3gZ58QsEGFJTly8");
